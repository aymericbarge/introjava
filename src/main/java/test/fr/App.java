...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // // Exo Café crème
        // int piecesJaune = compterPieces(clavier);
        // if (piecesJaune < 100) {
        //     int pieceManquante = 100 - piecesJaune;
        //     System.out.println("Il vous manque " + pieceManquante + " cents pour prendre un café !");
        ...
        //     System.out.println("Il vous restera " + piecesEnTrop + " cents après avoir pris votre café !");
            // }
            ...
            // System.out.print("Entrez le nombre de ligne que vous voulez : ");
            // int taille = clavier.nextInt();
            // for (int nombreDeLigne = taille; nombreDeLigne >= 1; nombreDeLigne--) {
            // for (int numberOfColumns = 1; numberOfColumns < nombreDeLigne;
            // numberOfColumns++)
            // System.out.print(" ");
            // for (int nombreDeColonne = nombreDeLigne; nombreDeColonne >= nombreDeLigne;
            // nombreDeColonne--)
            // System.out.print(nombreDeLigne);
            // System.out.println();
            // }
    ...
    // private static int compterPieces(Scanner clavier) {
